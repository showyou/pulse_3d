...
public class NoteController : MonoBehaviour
{
    ...
    public void Init(float hitTimeSec, int[] lanes, bool isLong, float holdSec, RhythmGameManager manager)
    {
        ...
        HighwayBuilder.ApplyColor(mat, isLong ? ColorLong : ColorTap);
